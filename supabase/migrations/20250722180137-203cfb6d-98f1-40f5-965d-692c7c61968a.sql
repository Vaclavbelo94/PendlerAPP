...
-- Update UserRole enum to include company-specific roles
ALTER TYPE public.user_role ADD VALUE IF NOT EXISTS 'adecco_employee';
ALTER TYPE public.user_role ADD VALUE IF NOT EXISTS 'randstad_employee';
