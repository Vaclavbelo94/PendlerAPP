    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Plánované směny pro tento týden
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            {['Po', 'Út', 'St', 'Čt', 'Pá', 'So', 'Ne'].map((day, index) => (
              <div key={day} className="text-center">
                ...
                <div className="space-y-1">
                  <div className="h-12 bg-green-100 dark:bg-green-900/20 rounded flex items-center justify-center text-xs">
                    Ranní
                  </div>
                  <div className="h-12 bg-blue-100 dark:bg-blue-900/20 rounded flex items-center justify-center text-xs">
                    Odpolední
                  </div>
                  <div className="h-12 bg-purple-100 dark:bg-purple-900/20 rounded flex items-center justify-center text-xs">
                    Noční
                  </div>
                </div>
              </div>
