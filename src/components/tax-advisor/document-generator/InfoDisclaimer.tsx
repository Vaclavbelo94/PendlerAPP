...
const InfoDisclaimer: React.FC = () => {
  ...
  return (
    <div className="bg-muted/50 p-3 md:p-4 rounded-lg flex items-start md:items-center space-x-2 text-xs md:text-sm text-muted-foreground">
      ...
      <p>
        {t('documentGeneratorDisclaimer') || 'Vygenerované dokumenty slouží jako pomůcka pro přípravu vašeho daňového přiznání. Přestože jsou připraveny podle aktuálních předpisů, zkontrolujte si všechny údaje před oficiálním podáním.'}
      </p>
    </div>
  );
};
