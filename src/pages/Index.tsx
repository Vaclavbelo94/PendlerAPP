      ...
      <div className="flex flex-col min-h-screen">
        <main className="flex-grow relative">
          <AnimatePresence>
            ...
            {user && !canAccess && (
              <motion.div 
                className="bg-amber-100 text-amber-800 py-3 px-4 text-center relative overflow-hidden"
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
              >
          ...
          {/* Přepínač tématu v pravém dolním rohu */}
          <motion.div
          ...
          <AnimatePresence>
            {scrolled && (
              ...
              >
                <motion.button
                  className="bg-primary text-primary-foreground p-3 rounded-full shadow-lg hover:shadow-xl"
