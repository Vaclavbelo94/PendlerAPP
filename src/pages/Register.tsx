...
import { UserIcon, KeyIcon, MailIcon, UserPlusIcon, EyeIcon, EyeOffIcon } from "lucide-react";
          ...
          <CardContent>
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-gray-700">Jméno</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="confirm-password" className="text-gray-700">Potvrzení hesla</Label>
                <div className="relative">
                  <div className="absolute left-3 top-3 text-gray-400">
                    <KeyIcon className="h-5 w-5" />
                  </div>
              ...
              <Button 
                type="submit" 
                className="w-full h-12 text-base font-medium shadow-lg shadow-primary-500/20 mt-4"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
