...
import PendlerCalculator from '@/components/tax-advisor/PendlerCalculator';
import PremiumCheck from '@/components/premium/PremiumCheck';

const PendlerCalculatorPage = () => {
  const { t } = useTranslation('pendlerCalculator');

  return (
    <Layout navbarRightContent={<NavbarRightContent />}>
      <PremiumCheck featureKey="pendler-calculator">
...
export default PendlerCalculatorPage;
